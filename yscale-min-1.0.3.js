...
exports.yScale=function(c,d){var b,a,e,f=[];b=d-c;a=this.yScaleMax(b);a[0]*a[1]-b<=a[0]&&(a=this.yScaleMax(b+a[0]));c<=a[0]&&(a=this.yScaleMax(d));e=c-a[0];e=0>=e?0:e+(a[0]-e%a[0]);b=e+a[0]*a[1];b-a[0]>d&&(b-=a[0]);do f.push(e),e=Math.round(1E3*(e+a[0]))/1E3;while(e<=b);if(11<f.length)throw Error("Unknown error");return f};
